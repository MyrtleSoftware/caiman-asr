...
class DaliPipeline(nvidia.dali.pipeline.Pipeline):
    ...
    def from_config(cls, pipeline_type, device_id, batch_size, file_root: str, sampler, config_data: dict,
                    config_features: dict, normalize: bool, num_cpu_threads: int, device_type: str = "gpu",
    ...
    def define_graph(self):
        ...
        # modified to return audio and audio_len on the preprocessing device - rob@myrtle
