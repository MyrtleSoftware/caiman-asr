...
def extract(sample_rate, n_fft, mel_dim):
    ...
    class SimplePipeline(Pipeline):
        def __init__(self, batch_size, num_threads, device_id):
            ...
            self.input = ops.NumpyReader(file_root = root_dir, file_list = '/tmp/exmat_file_list.txt')
            self.mel = ops.MelFilterBank(sample_rate=sample_rate, nfilter=mel_dim, normalize=True)
            #
