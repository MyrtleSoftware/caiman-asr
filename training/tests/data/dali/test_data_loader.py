...
def test_samplers_initialization(
    ...
    assert isinstance(dataloader1.sampler, sampler.Sampler)
    ...
    assert isinstance(dataloader2.sampler, sampler.Sampler)
    ...
    assert cmp(txt_list[0], txt_list[2]) or cmp(txt_list[0], txt_list[3])
