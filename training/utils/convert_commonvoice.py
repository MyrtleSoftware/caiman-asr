...
parser = argparse.ArgumentParser(description='Convert CommonVoice tsv files to RNNT json files')
parser.add_argument('--input_dir', type=str, required=True,
                    help='CommonVoice language-specific input dir')
parser.add_argument('--input_tsv', type=str, default='./',
                    help='name of the input .tsv file')
