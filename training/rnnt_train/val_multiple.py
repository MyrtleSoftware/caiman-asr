...
from rnnt_train.args.val import check_val_arguments
from rnnt_train.common.torchrun import maybe_restart_with_torchrun
from rnnt_train.setup.val import ValCPUSetup, ValSetup
from rnnt_train.val import check_shared_args, val_arg_parser, validate
...
if __name__ == "__main__":
    ...
    maybe_restart_with_torchrun(
        ...
        "/workspace/training/rnnt_train/val_multiple.py",
    )
